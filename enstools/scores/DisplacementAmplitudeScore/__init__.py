...
def das(obs, fct, factor=4, threshold=None):
    ...
    *Philosophy*: complete miss equals 100% amplitude error
    ...
    both components published in the reference publication [1]_.
    ...
    dict
            ...
            rms_obs:
                root mean square of observation
            morph_o:
                morphed fct to obs
            morph_f:
                morphed obs to fct
            xdis_o:
                x-displacement of fct morphed to obs
            ydis_o:
                y-displacement of fct morphed to obs
            xdis_f:
                x-displacement of obs morphed to fct
            ydis_f:
                y-displacement of obs morphed to fct
            lse_o:
                least square error of fct morphed to obs
            lse_f:
                least square error of fct morphed to obs
